        ...
        <li class='slide absolute transition-transform duration-1000 flex flex-col mb-4 h-auto overflow-scroll justify-center items-center mt-4 '>
          <div class='wrapper'>
            <div class='flex items-center'>
              ...
              <a class='ml-auto' href="${review.authorAttribution.uri}"><img width=30 height=30 src="./dist/assets/google.png" alt="" /></a>
            </div>
            <img width=150 class='my-2' src="./dist/assets/stars.png" alt="" />
            <p class='mb-4'>
